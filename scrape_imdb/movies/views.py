...
def scrape_movies(request):
    if request.user.is_staff:
        ...
        return Response(
            {
                "message": 'Scraping in progress. Visit http://127.0.0.1:5555/tasks for the status of the task. For local development the username is "test" and password is "test"'
            }
        )
